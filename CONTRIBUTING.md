...
Plugin source code is hosted on [GitHub](https://github.com/jenkinsci/git-prebuildmerge-trait-plugin).
...
[Cloudbees Jenkins job](https://ci.jenkins.io/job/Plugins/job/git-prebuildmerge-trait-plugin/).
...
Code formatting in the git-premerge-trait plugin varies between files.  Try to
